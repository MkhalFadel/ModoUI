...
export function PrimaryAlert({ text, props }) {
   ...
   return (
      <div className={styles.alert} style={style}>
         ...
         <p className={styles.message}>{text || "This is a primary alert!"}</p>
      </div>
   );
}
...
export function SuccessAlert({ text, props }) {
   ...
   return (
      <div className={styles.alert} style={style}>
         ...
         <p className={styles.message}>{text || "Action completed successfully!"}</p>
      </div>
   );
}
...
export function WarningAlert({ text, props }) {
   ...
   return (
      <div className={styles.alert} style={style}>
         ...
         <p className={styles.message}>{text || "Be careful with this action!"}</p>
      </div>
   );
}
...
export function ErrorAlert({ text, props }) {
   ...
   return (
      <div className={styles.alert} style={style}>
         <span className={styles.icon}>❌</span>
         <p className={styles.message}>{text || "Something went wrong!"}</p>
      </div>
   );
}
...
export function InfoAlert({ text, props }) {
   ...
   return (
      <div className={styles.alert} style={style}>
         <span className={styles.icon}>💡</span>
         <p className={styles.message}>{text || "Here’s some helpful information."}</p>
      </div>
   );
}
